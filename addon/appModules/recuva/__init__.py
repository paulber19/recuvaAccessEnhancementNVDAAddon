...
from rc_py3Compatibility import _unicode
...
class AppModule(appModuleHandler.AppModule):
	...
	def chooseNVDAObjectOverlayClasses(self, obj, clsList):
		if obj.role == controlTypes.ROLE_RADIOBUTTON and obj.windowControlID in _typeRadioButtonControlIDs: 
		...
		if obj.role == controlTypes.ROLE_PROPERTYPAGE and obj.childCount in [14, 17]:
			...
			return
		if obj.role == controlTypes.ROLE_PROPERTYPAGE and obj.windowControlID == 1045:
		...
		if (obj.role == controlTypes.ROLE_LIST and obj.windowClassName == "RC Files list"
			or obj.role == controlTypes.ROLE_TREEVIEW and obj.windowClassName == "RC Files Tree"):
